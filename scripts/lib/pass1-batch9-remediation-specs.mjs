...
export const FAQ_BY_SLUG = {
	...
	'guy-avni-construction-defects-claim-filing': [
		{ question: 'מה השלב הראשון?', answer: 'תיעוד ודיווח בכתב לקבלן.' },
		{ question: 'צריך חוות דעת?', answer: 'כן, לתביעה משמעותית.' },
		{ question: 'גישור לפני בית משפט?', answer: 'מומלץ; חוסך זמן ועלות.' },
		{ question: 'מה אפשר לתבוע?', answer: 'תיקון, פיצוי והוצאות לפי חוק וחוזה.' },
	],
	'guy-avni-consumer-protection-fourteen-day-cancellation-exceptions': [
		{ question: 'תמיד יש 14 יום?', answer: 'לא; בעיקר עסקאות מרחוק מסוימות.' },
		{ question: 'נדל"ן?', answer: 'לרוב אין זכות ביטול 14 יום.' },
		{ question: 'איך מבטלים?', answer: 'הודעה בכתב בתוך המועד לפי החוק.' },
		{ question: 'שירות מותאם?', answer: 'לרוב פטור מזכות ביטול.' },
	],
};
