...
const patterns = [
  ...
  {
    name: 'log.*MOONPAY_SECRET_KEY in call',
    rg: String.raw`log\.(info|warn|error)\([^)]*\bMOONPAY_SECRET_KEY\b`,
  },
  {
    name: 'log.*MOONPAY_WEBHOOK in call',
    rg: String.raw`log\.(info|warn|error)\([^)]*\bMOONPAY_WEBHOOK_(API_)?KEY\b`,
  },
];
